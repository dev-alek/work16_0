...
define variable p-petrol as logical no-undo init yes.
define variable p-goods as logical no-undo init yes.
define variable p-services as logical no-undo init yes.
...
:
  ...
  run rep/rpychk0.p ( input "exp-elc2"
  ...
  /*    run clear-treal in this-procedure .*/
    ...
    if not v-to-export then next _chk-doc.
