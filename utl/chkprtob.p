...
define variable vss-revision    as character no-undo init "$Revision$".
define variable vss-author      as character no-undo init "$Author$".
define variable vss-date        as character no-undo init "$Date$".
