...
/*      v-mm:R2                      = R2 */
    ...
    assign
      p-tank-weight-rvs   = v-mm:M
      p-tank-vol-pomi-rvs = ((v-mm:V_total2 - v-mm:V_water2) - (v-mm:V_total1 - v-mm:V_water1)) * 1000
    .
    infoSecObj:TankWeightRvs = p-tank-weight-rvs .
    infoSecObj:TankVolPomiRvs = p-tank-vol-pomi-rvs .
    infoSecObj:AvgTempRvs = (bf_bef_rvs-line.state-temperature + bf_aft_rvs-line.state-temperature) / 2 .
