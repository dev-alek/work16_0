...
find first buf_goods-attr where buf_goods-attr.gds-code = cash-gds.gds-code 
    ...
    then do:
      ...
      else if buf_goods-attr.attr-value = MarkType:NSJ         :NameProp then run bgelib-tag-put in this-procedure ( input 3, input "ItemDataMatrixType"  , input string(MarkType:tabak:KeyIntDB ) , input 1 ).
      ...
      else if buf_goods-attr.attr-value = MarkType:BAd         :NameProp then run bgelib-tag-put in this-procedure ( input 3, input "ItemDataMatrixType"  , input string(MarkType:milk:KeyIntDB )  , input 1 ).
      else if buf_goods-attr.attr-value = MarkType:antiseptic  :NameProp then run bgelib-tag-put in this-procedure ( input 3, input "ItemDataMatrixType"  , input string(MarkType:milk:KeyIntDB )  , input 1 ).
