...
define variable v-mark as character format "X(255)" view-as fill-in size 80 by 1 label "ћарка" .
...
ON return OF v-mark in FRAME Dialog-Frame /* ¬вод марок */
DO:
    assign v-mark .
    create tt-marks .
    assign
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* ¬вод марок */
DO:
...
ON choose OF Btn_Cancel in FRAME Dialog-Frame /* ¬вод марок */
DO:
...
ON choose OF Btn_ok in FRAME Dialog-Frame /* ¬вод марок */
DO:
...
ON choose OF Btn_del in FRAME Dialog-Frame /* ¬вод марок */
DO:
