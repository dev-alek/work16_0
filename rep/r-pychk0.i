  ...
  if first-of(ub.CHK-pay.DOC-CODE) THEN Do:
    ...
    BY ub.chk-gds.line-num:
      ...
      if temp-chk-gds.sum < 0 then do:
        /* если Да, то остаток нераспределенной суммы обнуляем по продаже и возврату */
