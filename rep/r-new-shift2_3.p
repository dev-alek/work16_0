...
put stream OutStr-html unformatted                                                              
  ...
  '<tbody> <!-- Здесь начинается таблица отчета -->                                             
                ...
                <th text_wrap="true" rowspan="3" style="text-align: center;">Остаток на конец</th>                       
            </tr>                                                                                       
            <tr>                                                                                        
...
FOR EACH t-2 USE-INDEX pi :
  ...
  assign 
    t-2.lines = MAX( curr-real-ii - loc-grp-only-not-single
...
/*        }                 */
    ...
    do while true :
      ...
      do:
        put stream OutStr-html unformatted
          ...
          if supp-line = no then "" else string(pol9,"->>>>>>>>>>>9.999"),
          if supp-line = no or pol8 = ? or pol6 = "" then "" else string(pol8,">>>>>>>>>>>9.9999"),
          if supp-line = no or pol9_1 = ? or pol6 = "" then "" else string(pol9_1,"->>>>>>>>>>>9.999"),
        ...
        put stream OutStr-html unformatted
          ...
          if supp-line = no then "" else string(pol7,">>>>>>>>>>>9.999"),
          if main-line = no then "" else string(pol18,"->>>>>>>>>>>9.999")
          ).
  ...
  DO:
    ...
    put stream OutStr-html unformatted
      substitute (
      '  <tr>
                    <th rowspan="2" text_wrap="true" style="text-align: left; vertical-align: middle;">&1</th>
                    <th rowspan="2"></th>
