...
{ rep/menu-doc.i {&TDEDT_Inv} "'*'" "'*'" "'*'"              "'Сличительная ведомость результатов инвентаризации СУГ'"                "'cost,sale,rubl,base'" "'rep/r-orsvx-sug.p'"  "''"                                 "'--+----'"  "'yukos,Rosneft-*'"   "'HTML'"          "''"                   "is-ptrl = 'yes'" }
...
{ rep/menu-doc.i {&TDEDT_Inv} {&fact} "'*'" "'*'"            "'Инвентаризационная опись нефтепродуктов'"                              "'cost,sale,rubl,base'" "'rep/r-orioxl-pokmi.p'" "''"                            "'--+----'"  "'yukos,Rosneft-*'"   "'HTML'"      "''"                   "is-ptrl = 'yes'" }
...
{ rep/menu-doc.i {&TDEDT_Inv} {&fact} "'*'" "'*'"            "'Акт на списание материалов'"                                         "'cost,sale,rubl,base'" "'rep/r-achmat.p'"  "''"                        "'+-----+'"  "'yukos,Rosneft-*'"       "''"     "''"  ? }
