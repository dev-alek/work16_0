...
/*        ).                                            */
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(buf_doc-line.doc-qnty, "->>>>>>>>9.999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(buf_doc-line.doc-density, "->>>>>>>>9.9999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(buf_doc-line.cli-qnty, "->>>>>>>>9.999")
        ).
        ...
        /* на 11.12.2014г Ведущий программист сообщил, что во всех случаях используем упрощённую схему: 6.4 = 5.4 * 0,0065. */
        run apn-xl-write-cell-data in this-procedure (
              input {&apn-xl-error_meas_kg}
            , input fnc-convert-dot-to-colon((((decimal(v-car-vol) + decimal(v-mouth)) * decimal(v-tank-density)) * 0.0065), "->>>>>>>>9.999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(
                                            ((((decimal(v-car-vol) + decimal(v-mouth)) * decimal(v-tank-density)) * 0.0065) + 
                                            v-norm-natur-loss)
                                            , "->>>>>>>>9.999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon((decimal(v-tank-weight) * 0.0065), "->>>>>>>>9.999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(
                                              buf_doc-line.doc-qnty - (decimal(v-car-vol) + decimal(v-mouth))
                                              , "->>>>>>>>9.999")
        ).
        ...
        run apn-xl-write-cell-data in this-procedure (
            ...
            , input fnc-convert-dot-to-colon(
                                            (buf_doc-line.doc-density - decimal(v-tank-density))
                                            , "->>>>>>>>9.9999")
        ).
        ...
        do: /* v */
            ...
            v-diff-qnty-kg = (buf_doc-line.cli-qnty -
                             ((decimal(v-car-vol) + decimal(v-mouth)) * decimal(v-tank-density))).

            /* ТЗ: Поле-6.4 "Погрешность измерений (кг) факт" */
            v-error-meas-kg = (((decimal(v-car-vol) + decimal(v-mouth)) * decimal(v-tank-density)) * 0.0065).


            if absolute(v-diff-qnty-kg) <= v-error-meas-kg then
            do:
            ...
            do:
                ...
                v-shortage-surplus-kg = v-diff-qnty-kg + v-error-meas-kg.
                end.
                else v-shortage-surplus-kg = v-diff-qnty-kg - v-error-meas-kg.
            end.
        end. /* v */
        run apn-xl-write-cell-data in this-procedure (
        ...
        do: /* v2 */
            ...
            v-error-meas-kg-15C = decimal(v-tank-weight) * 0.0065.

            if absolute(v-diff-qnty-kg-15C) <= v-error-meas-kg-15C then
            do:
            ...
            do:
                ...
                v-shortage-surplus-kg-15C = v-diff-qnty-kg-15C + v-error-meas-kg-15C.
                end.
                else v-shortage-surplus-kg-15C = v-diff-qnty-kg-15C - v-error-meas-kg-15C.
            end.
