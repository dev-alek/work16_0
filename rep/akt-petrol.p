...
do
    ...
    put stream OutStr-html unformatted
        ...
        '<TR><TD colspan="10" style="font-weight: bold; text-align: center;">АКТ</TD></TR>' skip
                            
        '<TR><TD colspan="10" style="font-weight: bold; text-align: center;">приема нефтепродуктов</TD></TR>' skip
