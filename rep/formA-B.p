...
for each tt-rep1 where tt-rep1.ext-doc-type = {&TDEDT_Ras_Vnesh}: 
...
for each tt-rep1 where tt-rep1.ext-doc-type = {&TDEDT_Ras_Perem} or tt-rep1.ext-doc-type = {&TDEDT_Ras_Vnesh} : 
    ...
    do:
        put stream OutStr-html unformatted
            ...
            '         <td  style="border: none; text-align: left;border-right: 1px solid black;"></td>' skip          
            '         <td  style="border: none; text-align: left; border-left: 1px solid black;"></td>' skip           
            '         <td colspan = "6" style="border: none; text-align: center; border-bottom: 1px solid black;">' + '  срок действия лицензии с ' +   fnc-DD-MM-YYYY(date(string( tt-rep1.supp-date-from ,"99.99.9999"))) + ' по ' + fnc-DD-MM-YYYY(date(string( tt-rep1.supp-lic-date-to ,"99.99.9999"))) + ', </td>'  skip
            '         <td  style="border: none; text-align: left;border-right: 1px solid black;"></td>' skip              
            '</tr>' skip
        ...
        put stream OutStr-html unformatted
            ...
            '         <td colspan = "6" style="border: none; text-align: center; border-bottom: 1px solid black;"> ИНН ' + string(tt-rep1.inn) + ' / КПП ' + string(tt-rep1.kpp) +   '</td>'  skip 
            '         <td  style="border: none; text-align: left;border-right: 1px solid black;"></td>' skip          
            '         <td  style="border: none; text-align: left; border-left: 1px solid black;"></td>' skip          
