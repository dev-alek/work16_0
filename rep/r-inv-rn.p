...
"Излишки (+) в рознич. ценах (облагаемые 18%) без НДС"  + {&comma-char} +
"Излишки (+) в рознич. ценах без НДС"  + {&comma-char} +
"Недостача (-) в уч. ценах без НДС (облагаемая по ставке 18%)"  + {&comma-char} +
"Сумма НДС (18%) относящийся к недостаче" + {&comma-char} +
...
"Реализация (в учет. ценах без НДС. облагаемая 18%)"  + {&comma-char} +
