...
v-report-name-html = session:temp-directory + string(g#report-num) + ".html".   
             
run print-html in this-procedure .
...
procedure print-html:
  if not p-det-obj then 
  do:
      ...
      '<!doctype html>
            <html>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="Движение денежных средств" fit_to_page="true">  
                    <thead>  <!-- Шапка отчета -->
                      <tr >
                    ...
                    <tr>
                      <td colspan="7" style="font-size:16px;font-weight:bold; text-align: center;">Движение денежных средств</td>
                    </tr>
                    <tr>
                      <td colspan="7" style="text-align: center;"> За период с &2 по &3 </td>
                    </tr>
                    <tr>
                      <td colspan="7"> </td>
                    </tr></thead>'
      ...
      put stream OutStr-html unformatted                                                                     
        ...
        '
                  <tr> <!--Подвал-->
                    ...
                    <tr> 
                    <td colspan="3" style="height:30px;"> Отчет составил и смену сдал:</td>
                    <td></td>
                  ...
                  <tr> 
                    ...
                    <tr> 
                    <td colspan="3" style="height:30px;"> Смену принял:</td>
                    <td></td>
                  ...
                  <tr> 
                    ...
                    <tr>
                    <td colspan="3" style="height:30px;"> Отчет проверил:</td>
                    <td></td>
                    <td style="border-bottom: 1px solid black; text-align: center;"></td>
                    <td></td>
                    <td style="border-bottom: 1px solid black; text-align: center;"></td>
        ...
        '                                                                                      
        /*            ,                        */
        /*            temp-fin-doc.staff-curr1,*/
        /*            temp-fin-doc.staff-curr2,*/
        /*            temp-fin-doc.staff-next2,*/
  ...
  do:
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="Движение денежных средств" fit_to_page="true">  
                    ...
                    <tr>
                      <td colspan="7" style="text-align: center;"> За период с &1 по &2 </td>
                    </tr>
                    <tr>
                      <td colspan="7"> </td>
                    </tr></thead>'
    ...
    for each buf_obj-list:
      put stream OutStr-html unformatted
        substitute (
        '<tr>
                <td colspan="7" style="text-align: left;">&1</td>
      ...
      do:
        ...
        do:                                 
          ...
          assign
            ...
            temp-fin-doc.ost-end       = temp-fin-doc.ost-end + (v-ost-begin + ( v-income-realiZ + v-income-other ) - ( v-expense-bank + v-expense-other ))
            .
        end.
        else 
        do:
