...
/*                    '       <tr style="display: ' + v-display + '">' skip*/ /* Назначать стили дочерним элементам <td> здесь не стоит, т.к. у меня нарушилось формирование Level для Excel!!! */
                    ...
                    '         <td num="0" style="display: ' + v-display + '; text-align: right; font-weight: bold">' + (if buf3_dcards.counter = 0 then "" else (string(if buf3_dcards.counter <> ? then buf3_dcards.counter else "?"))) + '</td>' skip
...
/*                    '       <tr style="display: ' + v-display + '">' skip*/ /* Назначать стили дочерним элементам <td> здесь не стоит, т.к. у меня нарушилось формирование Level для Excel!!! */
                    ...
                    '         <td num="0" style="display: ' + v-display + '; text-align: right">' + (if buf3_dcards.counter = 0 then "" else (string(if buf3_dcards.counter <> ? then buf3_dcards.counter else "?"))) + '</td>' skip
