...
put stream OutStr-html unformatted
  ...
  '<tbody> <!-- Здесь начинается таблица отчета -->
            <tr> <!-- Первые строки – шапка таблицы с тэгами tr -->
                <th colspan="8" style="text-align: center;">Движение денежных средств</th>
            </tr>
            <tr>
    ...
    put stream OutStr-html unformatted
      ...
      '<tfoot>
       ...
       <tr>
                ...
                <td colspan="6" style="text-align: left;">&1</td>
       </tr>               
       <tr>
       ...
       <tr>
                ...
                <td style="text-align: right;"></td>
                <td colspan="6" style="text-align: left;">&4</td>
       </tr>  
       <tr>
                <td colspan="2" style="text-align: left;"></td>
                <td style="text-align: right;"></td>
       ...
       <tr>
                ...
                <td style="text-align: right;"></td>
                <td colspan="6" style="text-align: left;">&5</td>
       </tr>                                
       <tr>
                <td colspan="2" style="text-align: left;"></td>
                <td style="text-align: right;"></td>
       ...
       <tr>
                ...
                <td style="text-align: right;"></td>
                <td colspan="6" style="text-align: left;">&6</td>
       </tr>     
       <tr>
                <td colspan="2" style="text-align: left;"></td>
                <td style="text-align: right;"></td>
      ...
      '<tfoot>
       ...
       <tr>
                ...
                <td style="text-align: right;"></td>
                <td colspan="5" style="text-align: left;">&2</td>
       </tr>
       <tr>
                <td colspan="2" style="text-align: left;"></td>
                <td style="text-align: right;"></td>
