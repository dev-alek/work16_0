...
if tog-9 = true then do:
  tog-list = tog-list + ',' + "tog-9".
  end.
if tog-10 = true then do:
...
.
  ...
  :
    ...
    FOR EACH ub.shift-staff No-LOCK WHERE
      ...
      if lookup( {&space-char} + ub.shift-staff.name, rep-shift-for-opers ) = 0 then do:
        assign
    ...
    FOR EACH ub.shift-staff No-LOCK WHERE
           ...
           ub.shift-staff.psn-num    >= 0 :
      if lookup( {&space-char} + ub.shift-staff.name, rep-shift-for-mng ) = 0 then do:
        assign
...
/*    end.*/
  ...
  assign rep-shift-for-mng-next = if available ub.shift-staff then string(ub.shift-staff.name, "X(30)") else "".
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="лист1" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="20" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="лист2" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="18" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="лист4" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="6" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="лист5" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="7" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="лист7" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="5" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
              ...
              <style>
                ...
                <body>
                  <table orientation="landscape" name="Сменный отчет" fit_to_page="true">  <!-- таблица, в которой содержится весь отчет -->
                    ...
                    <tr>
                      <td colspan="3" style="font-size:16px;font-weight:bold; text-align: center;">СМЕННЫЙ ОТЧЕТ АЗС № &2</td>
                    </tr>
                    <tr>
