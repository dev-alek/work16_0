...
&scop prop-code entry(v-ii, v-prop-code)
      ...
      v-prop-code = "{&bef-attr-petrol_autopump},{&bef-attr-petrol_avtinvpm},{&bef-attr-petrol_rvsnmter},{&bef-attr-petrol_olddens}".
&scop ptype logical
&scop prop-value no
&scop prop-code entry(v-ii, v-prop-code)
    ...
    v-prop-code = "{&bef-attr-staff-options_noanshftstaff}".
