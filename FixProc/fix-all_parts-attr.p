...
each buf_parts no-lock where buf_parts.out-code = buf_trn-doc.doc-code,
first buf_goods no-lock where buf_goods.artic = buf_parts.artic
                          and buf_goods.prod-type = buf_parts.prod-type
                          and buf_goods.prod-code = buf_parts.prod-code,
first buf_doc-line no-lock where buf_doc-line.doc-code = buf_trn-doc.doc-code
