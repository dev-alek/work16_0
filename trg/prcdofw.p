...
:
  ...
  if ub.price-doc-forming.main-pdf-id = 0 or ub.price-doc-forming.main-pdf-id = ? then do:
      assign
  ...
  if old_price-doc-forming.stts = integer({&pdf-fact}) then do:  /*{&fact}*/
      if new (ub.price-doc-forming) then do:
  ...
  if ub.price-doc-forming.stts = integer({&pdf-delete}) then do:  /*{&deleted-status}*/
  ...
  if g#news = false and  (
     ...
     ub.price-doc-forming.stts = integer({&pdf-delete}) )   then do:  /*{&fact}*/
