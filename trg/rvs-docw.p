...
:
  ...
  and ub.rvs-doc.status_ <> {&fact} then do:
    message
      vss-workfile vss-revision vss-description skip
  ...
  if buf-old_rvs-doc.status_ = ub.rvs-doc.status_ then do:
    return . /* --->>>--- */
  end.
  ...
  if ub.rvs-doc.host-code <> v-host-code then do:
    message
      vss-workfile vss-revision vss-description skip
...
procedure change-status-fact :
  ...
  :
    if g#news then do:
      ...
      or ub.rvs-doc.fact-order = 0 then do:
        message
          vss-workfile vss-revision vss-description skip
    ...
    if not g#news then do:
      ...
      if ub.rvs-doc.rvs-type = {&rvs-before-doc}
      or ub.rvs-doc.rvs-type = {&rvs-after-doc} then do:
        ...
        if ub.rvs-doc.rvs-type = {&rvs-after-doc} then do:
          find first before_rvs-doc no-lock
            ...
            no-error .
          if not available before_rvs-doc then do:
            message
              vss-workfile vss-revision vss-description skip
      ...
      if ub.rvs-doc.rvs-type = {&rvs-shift} then do:
        ...
        and ub.rvs-doc.out-code <> ?  then do:
          message
            vss-workfile vss-revision vss-description skip
      ...
      if ub.rvs-doc.fact-order > 0 then do:
        message
          vss-workfile vss-revision vss-description skip
      ...
      if available ub.trn-doc and
        ub.trn-doc.is-back-date then do:
        assign
        varis-back-date = yes.
      end.
