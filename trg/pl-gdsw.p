...
{&bef-TDEDT_Inv}':U
    ...
    then do:
      ...
      :
        if lookup( buf_doc-line.ext-doc-type, {&TDEDT_list_not-rsrv} ) > 0 then do:
          next.
        end.
      ...
      if new_pl-gds.cli-free-qnty <> new_pl-gds.cli-fact-qnty - v-cli-qnty then do:
        undo, return error substitute( 'Ошибка в свободном количестве на месте хранения&1'
                                        + 'Товар &2&1'
                                        + 'Место хранения: &3 (&4 &5)&1'
